...
//imagenes
import img01 from '../media/img01.jpeg'
  ...
  return <div>
    ...
    <section class="bg-gray-100 dark:bg-gray-900 lg:py-12 lg:flex lg:justify-center">
        <div class="bg-white dark:bg-gray-800 lg:mx-8 lg:flex lg:max-w-5xl lg:shadow-lg lg:rounded-lg">
            <div class="lg:w-1/2">
                <div class="h-64 bg-cover lg:rounded-lg lg:h-full" ></div>
            </div>

            <div class="max-w-xl px-6 py-12 lg:max-w-5xl lg:w-1/2">
                <h2 class="text-2xl font-bold text-gray-800 dark:text-white md:text-3xl">Construye tu nueva idea <span class="text-indigo-600 dark:text-indigo-400">Idea</span></h2>
                ...
                <div class="mt-8">
                    <a href="#" class="px-5 py-2 font-semibold text-gray-100 transition-colors duration-200 transform bg-gray-900 rounded-md hover:bg-gray-700">Comenzar</a>
                </div>
            </div>
        </div>
    </section> 
    ...
    <section class="container p-6 mx-auto bg-white dark:bg-gray-800">
        <h2 class="text-xl text-bold font-medium text-gray-800 capitalize dark:text-white md:text-2xl">Nuestro Equipo</h2>
        ...
        <div class="flex items-center justify-center">
            <div class="grid gap-8 mt-8 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                <div class="w-full max-w-xs text-center">
                    ...
                    <div class="mt-2">
                        <h3 class="text-lg font-medium text-gray-700 dark:text-gray-200">Asesor de Proyectos</h3>
                ...
                <div class="w-full max-w-xs text-center">
                    ...
                    <div class="mt-2">
                        <h3 class="text-lg font-medium text-gray-700 dark:text-gray-200">Asesora de Proyectos</h3>
                ...
                <div class="w-full max-w-xs text-center">
                    ...
                    <div class="mt-2">
                        <h3 class="text-lg font-medium text-gray-700 dark:text-gray-200">Asesora de Proyectos</h3>
                        <span class="mt-1 font-medium text-gray-600 dark:text-gray-300">Ingeniera de Software</span>
                    </div>
                </div>
            </div>
        </div>
